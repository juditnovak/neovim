...
int ADD_EXT_STR(termdata *td, int enum_code, const char *name, const char *instr) {
#ifdef UNIBI
...
void SET_STR(termdata *td, int enum_code, const char *instr) {
#ifdef UNIBI
...
void SET_BOOL(termdata *td, int enum_code, bool truefalse) {
#ifdef UNIBI
...
void SET_INT(termdata *td, int enum_code, int val) {
#ifdef UNIBI
